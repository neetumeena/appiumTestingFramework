...
public class CommonUtils {
    ...
    static String PROPERTYFILEPATH = System.getProperty("user.dir") + "src/test/resources/properties";
    ...
    public static void loadConfigProp(String propertyFileName) throws IOException {
        FileInputStream fis = new FileInputStream(PROPERTYFILEPATH + propertyFileName);
        prop.load(fis);
